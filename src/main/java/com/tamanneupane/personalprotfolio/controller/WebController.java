...
public class WebController {
    ...
    public String index(Model model){
        ...
        MyService android = new MyService("Android Application Development", "I can develop android application","fa-brands fa-android");
        MyService ios = new MyService("IOS Application Development", "I can develop IOS application","fa-brands fa-apple");
        MyService react = new MyService("React Application Development", "I can develop React application","fas fa-palette");
